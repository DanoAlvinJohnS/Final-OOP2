...
# Demo window with 2x2 grid
class DemoWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Circular Progress — Glow Grid")

        root = QWidget()
        self.setCentralWidget(root)
        grid = QGridLayout(root)

        self.g1 = FancyCircularProgress(15)
        self.g2 = FancyCircularProgress(45)
        self.g3 = FancyCircularProgress(70)
        self.g4 = FancyCircularProgress(95)

        grid.addWidget(self.g1, 0, 0)
        grid.addWidget(self.g2, 0, 1)
        grid.addWidget(self.g3, 1, 0)
        grid.addWidget(self.g4, 1, 1)
